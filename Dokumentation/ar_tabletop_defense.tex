...
\author{Cornelia Langsenlehner, BSc}
\date{\today}
...
approximately 705 lines of code.
...
\begin{figure}[H]
  ...
  \begin{minipage}{0.24\textwidth}
    \centering
    \includegraphics[width=\linewidth]{screenshot_gameplay_random1.png}
    \caption{(b) Gameplay with enemies following random paths.}
  \end{minipage}\hfill
  \begin{minipage}{0.24\textwidth}
    \centering
    \includegraphics[width=\linewidth]{screenshot_gameplay_frozen.png}
    \caption{(c) Game paused for 2 seconds after big enemy spawned.}
  \end{minipage}
    \begin{minipage}{0.24\textwidth}
    \centering
